...
#let runReader(mode) = {
  ...
  let shopeework = {
    ...
    translate(
      ...
      zh: cventry(
        ...
        - 业务介绍：开放平台提供 OpenAPI 鉴权授权、消息推送，门户站点等功能，为开发者提供全面的商家管理能力。
        - 主要负责网关插件、开发者控制台和推送系统等服务，提高鉴权授权性能，丰富控制台功能，提升系统可观测性，提高用户体验。
  ...
  let openservice = {
    ...
    translate(
      ...
      zh: [
        - 优化系统性能和稳定性，包括优化鉴权流程、页面延迟优化、增加降级策略等，保障系统稳定性，提升开发者体验。
        - 基于地区拆分方案优化推送系统，有效降低异地推送耗时（600ms->30ms）。并提供控制台测速功能，帮助开发者选择最佳推送服务器。
        - 为用户控制台添加多个模块，如统计看板、商业分析页、日志搜索、漏洞看板和推送测速等，丰富平台功能提升用户体验。
      ],
    )
  }
