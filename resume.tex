...
\begin{itemize}[parsep=0.5ex]
      ...
      \item \en{Skilled in using common middleware(ElasticSearch,ClickHouse,Kafka),can independently design and implement solutions}
            \zh{熟练使用工作常用中间件(ElasticSearch,ClickHouse,Kafka),能够根据需求独立设计和实现解决方案}
\end{itemize}
